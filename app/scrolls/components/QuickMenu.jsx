...
const QuickMenu = () => {
  ...
  return (
    <div className="absolute right-[10px] top-[45vh] bg-[rgba(0,0,0,.5)] rounded-[30px] h-[100px] p-[0px] flex flex-col items-center justify-evenly border border-[gray]">
      <a
        href="#"
        className="transition hover:-rotate-45 flex rounded-[10px] border-[#eee] "
      >
        <svg
      ...
      {/*  shadow-[0_11px_34px_0_rgba(0,0,0,0.2)] */}
      <a
        href="#"
        className="w-10 h-10 flex p-2 rounded-[10px] border-[#eee] hover:bg-[#eee]"
      >
        <div className="flex w-[28px] h-[22px] justify-around radius-1 items-baseline">
          <div className="book w-[6px] h-[22px] border-[#f00] border rounded-[2px]"></div>
          <div className="book w-[6px] h-[16px] border-[#f00] border rounded-[2px]"></div>
          <div className="book w-[6px] h-[18px] border-[#f00] border rounded-[2px]"></div>
        </div>
      </a>
    </div>
  );
