...
import Dustjacket from "./Dustjacket";
...
useEffect(() => {
  ...
  return (
    <>
      {isDJ && (
        <Dustjacket DJrightPageRef={DJrightPageRef} DJrightPageFlipRef={DJrightPageFlipRef} DJleftPageRef={DJleftPageRef} DJleftPageFlipRef={DJleftPageFlipRef} DJspinePageRef={DJspinePageRef} glassMaterialProps={glassMaterialProps} width={width} height={height} thickness={thickness} />
      )}
